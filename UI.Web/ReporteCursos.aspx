...
<asp:Content ContentPlaceHolderID="bodyContentPlaceHolder" RunAt="server" >
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="tp2_netDataSetCTableAdapters.cursosTableAdapter"></asp:ObjectDataSource>
    </div>
    </asp:Content>